...
def check_gender_age(emp):
    return emp['gender']=="Male" and emp['age']<=40

#male_employees_age40=list(filter(lambda emp:emp['gender']=='Male' and emp['age']<=40,employees))
male_employees_age40=list(filter(check_gender_age,employees))
